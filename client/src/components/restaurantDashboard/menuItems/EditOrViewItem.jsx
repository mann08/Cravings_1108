...
const CATEGORIES = [
  ...
  "Biryani", "Main Course", "Seafood", "Rice", "Starter", "Other",
];

const inputCls =
  "border border-(--color-secondary) rounded px-3 py-1.5 text-sm w-full focus:outline-none focus:ring-2 focus:ring-(--color-primary) disabled:bg-gray-100 disabled:cursor-not-allowed";
const labelCls =
  "font-semibold text-xs text-(--color-secondary) uppercase tracking-wide mb-0.5 block";
...
const EditOrViewItem = ({ isOpen, onClose, item, mode, onSave }) => {
  ...
  // Sync form when item/mode changes
  useEffect(() => {
    if (item) {
      setForm({ ...item });
          ...
          <div className="px-5 py-4 space-y-3">
            ...
            <div className="grid grid-cols-[130px_1fr] gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div
                  className={`border-2 border-dashed border-(--color-secondary) rounded-lg flex flex-col items-center justify-center transition-colors ${
                    !isView ? "cursor-pointer hover:border-(--color-primary)" : "cursor-default"
                  }`}
                  style={{ height: "130px" }}
              ...
              <div className="flex flex-col gap-2">
                <div>
                  ...
                  <input
                    ...
                    disabled={isView || isLoading} className={inputCls}
                  />
                </div>
                <div className="flex flex-col flex-1">
                  ...
                  <textarea
                    ...
                    className="border border-(--color-secondary) rounded px-3 py-1.5 text-sm w-full focus:outline-none focus:ring-2 focus:ring-(--color-primary) resize-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 299" disabled={isView || isLoading} className={inputCls}
                />
              </div>
              <div>
